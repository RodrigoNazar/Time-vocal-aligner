...
,'MinPeakProminence',100);
text(locs1(1),pks(1)+1000+2000,'Adiós')
text(locs1(2),pks(2)+1000+2000+2000,'Chimuelo')

% PEAKS L2
plot(L2)
ylim([0 60000])
findpeaks(L2,'NPeaks',3,'MinPeakDistance',1,'MinPeakHeight',15000 ...
,'MinPeakProminence',0)
[pks, locs2] = findpeaks(L2,'NPeaks',3,'MinPeakDistance',1,'MinPeakHeight',15000 ...
,'MinPeakProminence',0); locs2(2)=locs2(2)-1;
text(locs2(1)-20,pks(1)+1000+2000+2000,'Siempre')
text(locs2(2)-10,pks(2)+1000+2000+2000,'Te')
text(locs2(3)-10,pks(3)+1000+2000+2000,'Amamos')

% PEAKS L3
plot(L3)
ylim([0 60000])
findpeaks(L3,'NPeaks',3,'MinPeakDistance',6,'MinPeakHeight',4150 ...
,'MinPeakProminence',1)
[pks, locs3] = findpeaks(L3,'NPeaks',3,'MinPeakDistance',6,'MinPeakHeight',4150 ...
,'MinPeakProminence',1);
text(locs3(1)-20,pks(1)+1000+2000+2000,'Más')
text(locs3(2)-10,pks(2)+1000+2000+2000,'Que')
text(locs3(3)-30,pks(3)+1000+2000+2000,'Mascota')

% PEAKS L4
plot(L4)
ylim([0 60000])
findpeaks(L4,'NPeaks',3,'MinPeakDistance',5,'MinPeakHeight',4150 ...
,'MinPeakProminence',1,'MaxPeakWidth',5)
[pks, locs4] = findpeaks(L4,'NPeaks',3,'MinPeakDistance',5,'MinPeakHeight',4150 ...
,'MinPeakProminence',1,'MaxPeakWidth',5);
text(locs4(1)-20,pks(1)+1000+2000+2000,'Fuiste')
text(locs4(2)-10,pks(2)+1000+2000+2000,'un')
text(locs4(3),pks(3)+1000+2000+2000,'Hermano')
...
text(locs5(1),pks(1)+1000+2000+2000,'Chimuelo')

% PEAKS L6
plot(L6)
ylim([0 60000])
findpeaks(L6,'NPeaks',3,'MinPeakDistance',6,'MinPeakHeight',19000 ...
,'MinPeakProminence',1)
[pks, locs6] = findpeaks(L6,'NPeaks',3,'MinPeakDistance',6,'MinPeakHeight',19000 ...
,'MinPeakProminence',1);locs6=[locs6;387];pks=[pks;2749.898];
text(locs6(1),pks(1)+1000+2000+2000,'Descansa')
text(locs6(2)-10,pks(2)+1000+2000+2000,'En')
text(locs6(3)-10,pks(3)+1000+2000+2000+2000,'Paz')
hold off
...
sound(y_click,Fs)
%% Write Audio
audiowrite('palabras_detectadas_4.wav',y_click,Fs);